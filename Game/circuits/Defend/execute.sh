...
# Compile the circuit
circom Defend.circom --r1cs --wasm --sym --c
...
cd Defend_js
node generate_witness.js Defend.wasm input.json witness.wtns
...
snarkjs groth16 prove Defend_0001.zkey witness.wtns proof.json public.json

# Verify the proof
snarkjs groth16 verify verification_key.json public.json proof.json

# Generate a Solidity verifier that allows verifying proofs on Ethereum blockchain
snarkjs zkey export solidityverifier Defend_0001.zkey verifier.sol
