...
void Move_11_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Move_11_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 3803;}

uint get_number_of_components() {return 39;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 2803;}
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[65]); // line circom 96
...
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_sub(&expaux[0],&circuitConstants[3],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 5]); // line circom 98
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
std::string new_cmp_name = "lt";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessThan_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 37 ;
aux_cmp_num += 2;
}
}
...
uint aux_dimensions[1] = {2};
for (uint i = 0; i < 2; i++) {
std::string new_cmp_name = "upperrange"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint aux_dimensions[1] = {2};
for (uint i = 0; i < 2; i++) {
std::string new_cmp_name = "lowerrange"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+3725;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "zonerangelower";
mySubcomponents[aux_create+i] = aux_cmp_num;
GreaterThan_8_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 40 ;
aux_cmp_num += 3;
}
}
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "zonerangeupper";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessThan_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 37 ;
aux_cmp_num += 2;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "checkxright";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessThan_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 37 ;
aux_cmp_num += 2;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "checkxleft";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "checkright";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessThan_3_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 10 ;
aux_cmp_num += 2;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "checkleft";
mySubcomponents[aux_create+i] = aux_cmp_num;
GreaterThan_10_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 13 ;
aux_cmp_num += 3;
}
}
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "checkup";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessThan_3_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 10 ;
aux_cmp_num += 2;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "checkdown";
mySubcomponents[aux_create+i] = aux_cmp_num;
GreaterThan_10_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 13 ;
aux_cmp_num += 3;
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0],&circuitConstants[3]); // line circom 36
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + 0],&circuitConstants[3]); // line circom 41
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + 0],&circuitConstants[3]); // line circom 47
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + 0],&circuitConstants[3]); // line circom 52
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + 0],&circuitConstants[3]); // line circom 57
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0],&circuitConstants[3]); // line circom 62
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[3]); // line circom 68
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[8]].signalStart + 0],&circuitConstants[3]); // line circom 75
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[9]].signalStart + 0],&circuitConstants[3]); // line circom 80
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 3],&circuitConstants[5]); // line circom 86
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0],&circuitConstants[3]); // line circom 87
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 3],&circuitConstants[5]); // line circom 91
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[11]].signalStart + 0],&circuitConstants[3]); // line circom 92
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 4],&circuitConstants[5]); // line circom 96
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[12]].signalStart + 0],&circuitConstants[3]); // line circom 97
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 4],&circuitConstants[5]); // line circom 101
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[13]].signalStart + 0],&circuitConstants[3]); // line circom 102
