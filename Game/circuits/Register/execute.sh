...
snarkjs groth16 setup Register.r1cs pot12_final.ptau Register_0000.zkey

# Contribute to the phase 2 of the ceremony
snarkjs zkey contribute Register_0000.zkey Register_0001.zkey --name="1st Contributor Name" -v

# Export the verification key
snarkjs zkey export verificationkey Register_0001.zkey verification_key.json

# Generate a zk-proof associated to the circuit and the witness. This generates proof.json and public.json
snarkjs groth16 prove Register_0001.zkey witness.wtns proof.json public.json

# Verify the proof
snarkjs groth16 verify verification_key.json public.json proof.json

# Generate a Solidity verifier that allows verifying proofs on Ethereum blockchain
snarkjs zkey export solidityverifier Register_0001.zkey verifier.sol
